<nav id="navmenu" class="navmenu">
    <ul>
        ...
        <li class="dropdown"><a href="#"><span><img class="user-avatar margin-5" src="<?php echo $avatar; ?>"></img> <?php echo $_SESSION["usuario"]; ?></span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
        <ul>
