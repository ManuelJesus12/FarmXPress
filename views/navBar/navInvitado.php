<nav id="navmenu" class="navmenu">
    <ul>
        ...
        <li><a href="<?php echo $dirUrl."principal.php?methodUser=viewRegister"; ?>"><span class="btn element-green-bg btn-pill-green"><span><i class="margin-5 fa-solid fa-user-plus"></i>Crear Cuenta</span></span></a></li>
        <li><a href="<?php echo $dirUrl."principal.php?methodUser=viewLogin"; ?>"><span class="btn element-green-bg btn-pill-green"><span><i class="margin-5 fa-solid fa-right-to-bracket"></i>Iniciar Sesión</span></span></a></li>
    </ul>
