...
-- 1. Suscripciones
INSERT INTO Suscripciones (Nombre, Precio_Mensual, Duracion_Base) VALUES
('Básica', 10.00, 1),
('Pro', 25.00, 3),
('Premium', 40.00, 6);

-- 2. Ventajas
INSERT INTO Ventajas (Descripcion, Nombre, Estado, Suscripcion_ID) VALUES
...
('Envio gratuito', 'Premium 2', 1, 3);

-- 3. Categorias
INSERT INTO Categorias (Descripcion, Nombre, Cat_Padre_ID) VALUES
('Maquinaria agricola', 'Tractores', NULL),
('Insumos', 'Fertilizantes', NULL),
('Herramientas', 'Palas', NULL),
('Invernaderos', 'Túneles', NULL),
('Tecnologia', 'Drones', NULL);

-- 4. Usuarios
INSERT INTO Usuarios (Email, CIF, Nombre, Contraseña, Telefono, Direccion, Comunidad, Provincia, Fecha_Registro, Estado, Avatar, Tipo) VALUES
...
-- 6. Membresias
INSERT INTO Membresias (Usuario_ID, Suscripcion_ID, Fecha_Inicio, Fecha_Fin, Estado) VALUES
...
-- 8. Productos
INSERT INTO Productos (Referencia, Nombre, Descripcion, Precio_Mensual, Estado, Usuario_ID, Categoria_ID, Imagen) VALUES
('A0001', 'Tractor 1', 'Potente', 120.00, 1, 1, 1, NULL),
('A0002', 'Tractor 2', 'Moderno', 130.00, 1, 2, 1, NULL),
('A0003', 'Fertilizante 1', 'Ecologico', 20.00, 1, 3, 2, NULL),
...
('A0019', 'Dron 3', 'Alta definicion', 700.00, 1, 9, 5, NULL),
('A0020', 'Dron 4', 'Autonomo', 800.00, 1, 10, 5, NULL);
...
(120.00, '2023-01-01', '2027-01-31', 1, 11, 1),
(130.00, '2023-02-01', '2027-02-28', 1, 12, 2),
(20.00, '2023-03-01', '2027-03-31', 1, 13, 3),
(25.00, '2023-04-01', '2027-04-30', 1, 14, 4),
(15.00, '2023-05-01', '2027-05-31', 1, 15, 5),
(18.00, '2023-06-01', '2027-06-30', 1, 16, 6),
(200.00, '2023-07-01', '2027-07-31', 1, 17, 7),
(300.00, '2023-08-01', '2027-08-31', 1, 18, 8),
(500.00, '2023-09-01', '2027-09-30', 1, 19, 9),
(600.00, '2023-10-01', '2027-10-31', 1, 20, 10),
(80.00, '2023-01-01', '2027-01-31', 1, 11, 11),
(150.00, '2023-02-01', '2027-02-28', 1, 12, 12),
(22.00, '2023-03-01', '2027-03-31', 1, 13, 13),
(26.00, '2023-04-01', '2027-04-30', 1, 14, 14),
(16.00, '2023-05-01', '2027-05-31', 1, 15, 15),
(17.00, '2023-06-01', '2027-06-30', 1, 16, 16),
(250.00, '2023-07-01', '2027-07-31', 1, 17, 17),
(350.00, '2023-08-01', '2027-08-31', 1, 18, 18),
(700.00, '2023-09-01', '2027-09-30', 1, 19, 19),
(800.00, '2023-10-01', '2027-10-31', 1, 20, 20);
...
-- 12. Reseñas
INSERT INTO Reseñas (Comentario, Calificacion, Fecha_Hora, Usuario_ID, Producto_ID) VALUES
