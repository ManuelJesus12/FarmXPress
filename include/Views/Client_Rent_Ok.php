...
<article class="col-12 list-cat form-log site-section rounded elemeng-green-bg">
    ...
    <div class='row d-flex justify-content-evenly align-items-center'>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 card card-prod card-body element-green-border rounded" style='height:auto;' id="rent-details" >
            <h3 class='card-header element-green-bg lead' style='margin-bottom:30px'>Detalles del alquiler: <?php echo $rentControl["Nombre"]. " - ".$rentControl["Referencia"]; ?> </h3>
            <p><strong>Precio Total: </strong><span style="color:limegreen"><?php echo $rentControl["Precio_Total"]; ?> €</span></p>
            <p><strong>Precio Mensual: </strong><?php echo $rentControl["Precio_Mensual"]; ?> €</p>
            <p><strong>Fecha de inicio: </strong><?php echo date("d-m-Y H:i:s", strtotime($rentControl["Fecha_Inicio"])); ?> </p>
            <p><strong>Fecha de fin: </strong><?php echo date("d-m-Y H:i:s", strtotime($rentControl["Fecha_Fin"])); ?> </p>
        </div>
        <div class="col-lg-2"></div>
    </div>
<br>
